...
/**
 * sysmon - monitor and logs system performance metrics
 * @self: object
 * @args: arguments
 * Return: Success else failure
 */
static PyObject *sysmon(PyObject *self, PyObject *args)
{
    int success;
    int runtime;
...
static PyMethodDef SysMethods[] = {
    {"sysmon", sysmon, METH_VARARGS, "Logs system performace metrics to text file"},
    {NULL, NULL, 0, NULL}
};
